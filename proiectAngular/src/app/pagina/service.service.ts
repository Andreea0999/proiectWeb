...
export class ServiceService {
  ...
  getCateg():Observable<any>{
    let adresa="http://localhost/proiectWeb/select_categories.php";
  ...
  selectCateg(category:string):Observable<any>{
    let adresa="http://localhost/proiectWeb/choose_category.php?item="+ category;
  ...
  deleteProdus(nume):Observable<any>{
    let adresa="http://localhost/proiectWeb/delete_product.php?product="+ nume;
    return this.http.get(adresa).pipe(map((res)=>{
      return res;
    }));
  }
  insertProduct(data):Observable<any>{
    let adresa="http://localhost/proiectWeb/insert_product.php";
